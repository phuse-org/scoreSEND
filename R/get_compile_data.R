...
#' get_compile_data(studyid='STUDY1', xpt_dir='/path/to/xpt_root', appid='APP1')
#' }
#' @export

get_compile_data <- function(studyid, path_db = NULL, fake_study = FALSE, xpt_dir = NULL, appid = NULL) {
